...
class Email:
    def __init__(self, host,port, sender, password, receiver, title, message=None, path=None):
        """初始化Email
    ...
    def send(self):
        ...
        # 连接服务器并发送
        try:
            smtp_server = smtplib.SMTP_SSL(self.host,self.port)  # 连接sever
...
if __name__ == '__main__':
    ...
    e = Email(title='百度搜素测试报告',
              ...
              receiver='1045033116@qq.com',
              host='smtp.qq.com',
              port='465',
              sender='309506489@qq.com',
              password='qisgaudsxbunbhef',
              path=report
              )
    e.send()